...
(function () {
        ...
        window.require = function (mod) {
            if (mod === 'fs') {
                return {
                    ...
                    statSync: function (p) {
                        ...
                        return { isDirectory: function () { return !hasExt; },
                ...
                return {
                    inflateSync: function (buf) {
                        ...
                        try {
                            ...
                            return { toString: function () { return '/* inflate error */'; } };
                        }
                        ...
                        return {
                            ...
                            toString: function (enc) { return this._text; },
                        };
                    },
                };
            }
            if (mod === 'path') {
                return {
                    ...
                    extname:  function (p) { var m = String(p).match(/\.[^./\\]*$/); return m ? m[0] : ''; },
    ...
    if (typeof Buffer === 'undefined') {
        ...
        window.Buffer.alloc = function (n) { return new Uint8Array(n); };
    ...
    if (typeof Steam === 'undefined') {
        window.Steam = {
            ...
            shutdown:            function () {},
            getSteamId:          function () { return '0'; },
            getAppId:            function () { return 0; },
            isInBigPicture:      function () { return false; },
            ...
            storeStats:          function () {},
            currentLanguage:     function () { return 'english'; },
        };
    }
    ...
    if (typeof Utils === 'undefined') {
        console.error('[browser-shim] Utils is not defined: check script order in index.html.');
        return;
    }
    ...
    if (typeof Bitmap !== 'undefined') {
        ...
        Bitmap.prototype.drawText = function (text, x, y, maxWidth, lineHeight, align) {
            _orig_drawText.call(this, text, x, y, maxWidth, lineHeight, align || 'left');
        };
    }
}());
